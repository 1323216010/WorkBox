...
def elapsed_time(start_time, dict1):
    ...
    dict1['time_label'].setText((f'<img src="{dict1["clock_icon_path"]}" width="16" height="16"> Time: {elapsed_time}s')) # 更新时间标签
...
def print_welcome_info(dict1):
    dict1['console'].append("<span style='color: gray;'>Welcome to the application. Please enter a command or select an operation.</span>")