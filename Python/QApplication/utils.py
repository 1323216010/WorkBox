...
def elapsed_time(start_time, dict1):
    ...
    dict1['time_label'].setText(
        f'<img src="{dict1["clock_icon_path"]}" width="16" height="16"> Time: <span style="color: #FF7820;">{elapsed_time}s</span>')  # 更新时间标签
...
def set_res(dict1):
    ...
    dict1['help_notes_path'] = os.path.join(application_path, 'res', 'scroll.svg')
    ...
    dict1['help_notes'].setIcon(QIcon(dict1['help_notes_path']))
